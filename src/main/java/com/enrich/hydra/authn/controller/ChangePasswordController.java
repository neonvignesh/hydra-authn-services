...
import com.enrich.hydra.authn.service.ChangePasswordService;
...
public class ChangePasswordController {
	...
	public ResponseEntity<StandardResponseMessage> ChangePassword(@RequestBody UserInfoPojo client){		
		try {
			StandardResponseMessage result =  service.changePassword(client);
